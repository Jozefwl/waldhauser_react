...
import AboutboxM from "../components/AboutMeMobile";

//TODO: mobile landscape view
function About() {
  return (
    <>
      <BrowserView>
        ...
        <BoxClr color="black">
          <p>
            ...
            <br></br>I can model 3D parts, or make a program in JS, C, Lua. I
            can configure a Linux server, install docker, or make a VPN.
            <br></br>
            <br></br>I also <b>know my way</b> around{" "}
            <b>Cisco switches & routers</b> and a fair bit in networking.
            <br></br>
            <br></br>
            <strong>
            ...
            <br></br>
            <br></br>I know how to repair computers, including laptops and
            phones. I built numerous computers{" "}
